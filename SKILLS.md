...
- Recent releases: v0.8.0 (document attachments, ATTACHMENT_EXTENSIONS, defensive file serving), v0.9.0 (wide-screen layout, LAYOUT_MAX_WIDTH, width toggle), v0.9.1 (compact list spacing, valid nested wikitext lists), v0.9.2 (namespace table checkbox column, mobile navbar overflow)
