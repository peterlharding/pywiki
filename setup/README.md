...
| `ATTACHMENT_EXTENSIONS` | Uploadable file types, e.g. `png,jpg,pdf,docx,xlsx,pptx,csv,txt,md` (executable, web and macro-enabled Office types are always refused) |
...
```bash
curl -s http://127.0.0.1:8222/ | head -5
```
